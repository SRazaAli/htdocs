    ...
    <div class="row">
      ...
      <div class="col-10 search-bar">
        ...
        <div class="row">
          ...
          <div class="row">
            <div class="col">
              <h5 class="my-3 mx-2 fs-2">Enter new data</h5>
              
              <form class="my-4 mx-4" method="post">

                <div class="mb-3">
                  <label for="exampleInputEmail1" class="form-label">Name</label>
                  <input autocomplete="off" name="user_name" type="text" class="form-control py-2" aria-describedby="emailHelp">
                
                </div>
                
                <div class="mb-3">
                  <label for="exampleInputEmail1" class="form-label">E-mail</label>
                  <input autocomplete="off" name="user_email" type="email" class="form-control py-2" aria-describedby="emailHelp">
                </div>

                <div class="mb-3">
                  <label for="exampleInputEmail1" class="form-label">Grade</label>
                  <input autocomplete="off" name="user_grade" type="text" class="form-control py-2" aria-describedby="emailHelp">
                 
                </div>
                
                <div class="mb-3">
                  <label for="exampleInputPassword1" class="form-label">Password</label>
                  <input autocomplete="off" name="user_password" type="text" class="form-control py-2" >
                </div>
                
                <div class="d-flex justify-content-center mt-4">
                <button name="save" type="submit" class="btn btn-success " onclick="alert('Data Inserted Successfully')">Submit</button>
              ...
              <?php
                    ...
                    if(isset($_POST['save'])){
                      ...
                      $query = "
                      INSERT INTO `user_data` (`user_name`, `user_email`, `user_grade`, `user_password`) VALUES ('$user_name', '$user_email', '$user_grade', '$user_password');";
