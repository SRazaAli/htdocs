    ...
    <div class="row">
      ...
      <div class="col-10 search-bar">
        ...
        <div class="row">
          ...
          <div class="row">
            <div class="col">
              <h5 class="my-3 mx-2 fs-2">All Entries</h5>
                  ...
                  <?php
                      ...
                      if($result == true){
                        ...
                        while($row = mysqli_fetch_assoc($result)){
                          ...
                          <td>$user_grade</td>
                          <td>$user_password</td>
                          <td><a href='update.php?user_id=$user_id&user_name=$user_name&user_email=$user_email&user_grade=$user_grade&user_password=$user_password'><button class='btn btn-success fs-7'>Update</button></a></td>
                        </tr>";
                        } 
                      }
